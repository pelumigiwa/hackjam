...
define(function () {
  ...
  sgMail.setApiKey(
    appcfg.application.mailSettings.mailProvider2.sendgrid.api.key
  );
    ...
    switch (basefile) {
      ...
      case "":
        ...
        switch (subject.toLowerCase()) {
          case "otp":
            template =
              __dirname + appcfg.application.mailSettings.templates.otp.pug;
            break;
          default:
            template =
              __dirname + appcfg.application.mailSettings.templates.generic.pug;
            break;
        }
